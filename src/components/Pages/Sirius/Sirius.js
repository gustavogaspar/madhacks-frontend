...
class Sirius extends Component {
    ...
    async handleSubmit() {
        ...
        const urlToBackend = 'http://10.0.0.2:5000/tag?tag=' + botRes.data.messagePayload.text;
    ...
    async handleQuestion(btValue) {
        ...
        let res = await axios.post('http://0.0.0.0:5000/tag', params, { headers: dados, withCredentials: true })
